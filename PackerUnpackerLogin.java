...
class PackerUnpackerLogin extends Template implements ActionListener, Runnable {
  ...
  PackerUnpackerLogin() {
    ...
    TopLabel.setText("Haridas Packer Unpacker : Login");
  ...
  public void actionPerformed(ActionEvent ae) {
   ...
   if (ae.getSource() == SUBMIT) {
      if (Validate(value1, value2) == false) {
        text1.setText("");
        text2.setText("");
		JOptionPane.showMessageDialog(this, "Short username", "Error", JOptionPane.ERROR_MESSAGE);
        //System.out.println("Short username");
      }
      if (value1.equals("HaridasAdmin") && value2.equals("HaridasAdmin")) {
        ...
        if (attemp == 0) {
          ...
          System.out.println("No of attempts finish");
          this.dispose();
          System.exit(0);
        }
